...
function CompletedTaskItem({ content, removeItem, complateItem: completeItem }: TaskItemProps & TaskItemControlProps) {
    return <div className="group h-[3rem] bg-primary rounded-full px-4 py-2 flex items-center text-title-1 font-medium text-[1rem] mb-2 line-through opacity-75">
        <span className="iconify mr-2 text-[#CC00FF] text-opacity-50" data-icon="akar-icons:circle-check-fill" data-width="28" data-height="28"></span>
        {content}
